        ...
        data () {
            return {
                navbarOptions: {
                    ...
                    brandImagePath: './',
                    brandImage: require('../src/assets/sparclogo1.png'),
                    brandImageAltText: 'brand-image',
                    collapseButtonImageOpen: require('../src/assets/images/sparclogo.png'),
                    collapseButtonImageClose: require('../src/assets/images/sparclogo.png'),
                            ...
                            subMenuOptions: [
                                {
                                    type: 'link',
                                    text: 'Engagements',
                                    subText: 'Take a look at all the current engagements offered!',
                                    path: './userDashboard',
                                },
                                {
                                    type: 'hr',
